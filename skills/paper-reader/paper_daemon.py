...
2. **内联概念引用**: 在正文中优先使用标准 Markdown 相对链接，例如 `[Flow Matching](../_概念/1-生成模型/Flow Matching.md)`、`[DiT](../_概念/11-深度学习基础/DiT.md)`；如果路径暂时不确定，先写纯文本概念名，不要写 Obsidian 双链
...
### 执行步骤
1. 分析完论文后，列出笔记中所有概念引用（标准 Markdown 链接或纯文本术语）
